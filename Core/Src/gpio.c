...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = ULTRASONIC_KEY_Pin|PLASMA_KEY_Pin|DRY_KEY_Pin;
  ...
  HAL_NVIC_SetPriority(EXTI0_1_IRQn,2, 0); //EXTI2_3_IRQn 
  HAL_NVIC_EnableIRQ(EXTI0_1_IRQn);

   HAL_NVIC_SetPriority(EXTI2_3_IRQn ,2, 0); //EXTI2_3_IRQn 
